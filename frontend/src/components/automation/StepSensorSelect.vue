...
.step-title { font-size: calc(18px * var(--content-scale, 1)); font-weight: 700; color: var(--text-primary); margin: 0; }
...
.device-icon { font-size: calc(24px * var(--content-scale, 1)); }
.device-info { flex: 1; }
.device-name { font-size: calc(15px * var(--content-scale, 1)); font-weight: 600; color: var(--text-primary); }
.device-meta { display: flex; gap: 8px; align-items: center; margin-top: 2px; }
.category { font-size: calc(13px * var(--content-scale, 1)); color: var(--text-muted); }
.status { font-size: calc(12px * var(--content-scale, 1)); padding: 2px 8px; border-radius: 10px; background: var(--bg-secondary); color: var(--text-muted); }
...
.check-box {
  ...
  font-size: calc(13px * var(--content-scale, 1)); font-weight: 700; color: white; transition: all 0.15s;
}
