  ...
  <div id="app" :class="['content-size-' + fontSize, { 'has-sidebar': showShell, 'theme-dark': theme === 'dark' }]">
    ...
    <aside v-if="showShell" class="sidebar">
      ...
      <nav v-if="isAdmin" class="sidebar-nav">
        ...
        <router-link to="/emergency-failover" class="sidebar-link">
      ...
      <nav v-else class="sidebar-nav">
        ...
        <router-link v-if="!isFarmUser" to="/work-log" class="sidebar-link">
    ...
    >
      ...
      <nav v-else class="sidebar-nav">
        ...
        <router-link v-if="!isFarmUser" to="/work-log" class="sidebar-link" @click="isDrawerOpen = false">
          <span class="link-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><path d="M8 14l2 2 4-4"/></svg></span>
          <span>농작업 일정</span>
        </router-link>
